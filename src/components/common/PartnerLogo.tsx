...
export const PartnerLogo = ({ partner }: PartnerLogoProps) => {
  return (
    <motion.div
      className="relative group bg-white p-3 rounded-2xl shadow-md flex items-center justify-center flex-shrink-0 w-48 h-32 border border-gray-100 transition-all duration-300"
      whileHover={{
        y: -5,
